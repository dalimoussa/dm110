...
class Business_Calendar_Login Extends Business_Calendar {
...
<head>
<meta charset="UTF-8" />
<title>営業日カレンダー【Business Calendar】 - ログイン画面</title>
...
<script src="../js/login-js.php" defer="defer"></script>
</body>
</html>
...
EOM;
	...
	public function login_check() {
		...
		if ( $post_user === $this->admin_user && $post_pass === $this->admin_pass ) {
			$_SESSION['business_calendar_login'] = 'business_calendar_login_ok';

...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="ja" lang="ja">
	<head>
		...
		<title>QRコードを添え状に印字DM発送のフォーム　DM発送代行センター（QRM）</title>
			...
			<div id="main" class="form_index">
				...
				<div id="main-in">
					...
					<div id="main-contents3">
						...
						<h2 class="ttl01_wide">添え状 QRコード作成 フォーム</h2>
...
<?php endif; ?>
						<p class="m20"><strong class="big2 red01">当社にてDM発送する内容物にプラスして使われるものです。</strong><br />
							このページは添え状にQRコードを印字する専用ページです。</p>

						<p class="al-c m40"><img src="./image.png" width="760" height="1080" alt="" style="width:380px;max-width:97%;height:auto;border:4px solid #ccc"></p>
...
・NEW集客UP方法"><?php echo e($form->get('contents')); ?></textarea>
								...
								<tr>
									...
									<td>
										<div>
											<span>飛び先URL　　</span>
											<input type="text" name="qr1_url" class="middle" placeholder="例　https://www.dm110.jp/" value="<?php echo e($form->get('qr1_url')); ?>" />
								...
								<tr>
									...
									<td>
										<div>
											<span>飛び先URL　　</span>
											<input type="text" name="qr2_url" class="middle" placeholder="例　https://www.dm110.jp/" value="<?php echo e($form->get('qr2_url')); ?>" />
								...
								<tr>
									...
									<td>
										<div>
											<span>飛び先URL　　</span>
											<input type="text" name="qr3_url" class="middle" placeholder="例　https://www.dm110.jp/" value="<?php echo e($form->get('qr3_url')); ?>" />
								...
								<tr>
									...
									<td>
										<div>
											<span>飛び先URL　　</span>
											<input type="text" name="qr4_url" class="middle" placeholder="例　https://www.dm110.jp/" value="<?php echo e($form->get('qr4_url')); ?>" />
							...
							<div id="button_block">
								...
								<button type="submit" class="btn btn-form btn-large">添え状QRコードに申し込む</button>

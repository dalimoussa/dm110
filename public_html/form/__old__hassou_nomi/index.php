						...
						<form method="post" role="form" action="#main-contents3">
							<table>
								...
								<tr>
									...
									<td>
										姓：<input type="text" name="name01" class="narrow" value="<?php echo e($form->get('name01')); ?>" />
										名：<input type="text" name="name02" class="narrow" value="<?php echo e($form->get('name02')); ?>" />
										<?php echo $form->error('name01', '<span class="error">', '</span>'); ?>
										<?php echo $form->error('name02', '<span class="error">', '</span>'); ?>
									</td>
								</tr>
								<tr>
									<th>
								...
								<tr>
									...
									<td class="list copies">
										<ul>
											<li><label><input type="radio" name="copies" value="発送 ＋ 宛名ラベル当社作成"<?php if ($form->get('copies') == '発送 ＋ 宛名ラベル当社作成' ) : ?> checked="checked"<?php endif; ?> />発送 ＋ 宛名ラベル当社作成</label></li>
											<li><label><input type="radio" name="copies" value="発送 ＋ 宛名ラベルお客様より支給・当社で貼り"<?php if ($form->get('copies') == '発送 ＋ 宛名ラベルお客様より支給・当社で貼り' ) : ?> checked="checked"<?php endif; ?> />発送 ＋ 宛名ラベルお客様より支給・当社で貼り</label></li>
											<li><label><input type="radio" name="copies" value="発送 ＋ 宛名ラベル貼り済み・封入済み封筒支給"<?php if ($form->get('copies') == '発送 ＋ 宛名ラベル貼り済み・封入済み封筒支給' ) : ?> checked="checked"<?php endif; ?> />発送 ＋ 宛名ラベル貼り済み・封入済み封筒支給</label></li>
							...
							<div class="m20-t al-c">
								<div id="privacy_policy">
									...
									これらすべては永続的に存続するためです。<br /><br />
									
									このため、当社の賠償責任を明確化し、お客様にご理解いただいたうえで安心してお買い上げいただきたいと考えています。<br />
									当社サービスには万全を期していますが万一のトラブルのために当社の賠償責任について明確化します。<br />。</p>
							...
							<div id="button_block">
								<button type="submit" class="btn btn-form btn-large">これで見積もりする</button>

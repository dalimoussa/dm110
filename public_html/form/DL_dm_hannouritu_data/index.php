...
<head>
	...
	<title>DM反応率 実データ</title>
	<meta name="keywords" content="DM,集客,ダウンロード,無料,反応率,特徴" />
	<meta name="description" content="DM反応率の実データを基に最近のDM傾向を分析しました。メディアボックスDM発送代行センター" />
	...
	<div id="container">
		<div id="main" class="form_index"><div id="main-in">
			<ul id="breadcrumb" itemscope itemtype="https://schema.org/BreadcrumbList">
				...
				<li itemprop="itemListElement" itemscope itemtype="https://schema.org/ListItem"><span itemprop="name">DM反応率 実データ</span><meta itemprop="position" content="3" /></li>
			</ul>
...
<?php endif; ?>
				...
				<a href="#free_dwnload"><div id="dwn_mv"><div id="dwn_mv_in">
					<ul>
						<li class="sp_hidden"><img src="/images/dwn/hannouritu_mv1.png" alt="DMの反応率テストのデータをまとめました。最近の傾向を含めた対策も掲載。"></li>
						<li><img src="/images/dwn/hannouritu_mv2.png" alt="DM反応率 実データ"></li>
						<li><img src="/images/dwn/hannouritu_mv3.png" alt="pdf資料"></li>
					</ul>
				</div></div></a>
				<p class="sp_view mb30"><img src="/images/dwn/dwn_mv_kyotsu.png" alt="無料ダウンロード"></p>
				<p class="sp_view">DMの反応率テストのデータをまとめました。<br />最近の傾向を含めた対策も掲載。</p>

				<h1 class="ttl01_wide">DM反応率 実データ</h1>
				<p class="mb60">当社のお客様・コンサルタントと協力して、DMの反応率テストを行った時のデータをまとめました。<br />
					また、2017年度の傾向も含めていますので、対策にお使いください。</p>

				<h3 class="ttl02">顧客別DM反応率データ</h2>
				<ul class="dwn_nendo">
					<li>当社のデータ2010年度</li>
					<li>当社のデータ2015年度</li>
					<li>当社のデータ2017年8月迄</li>
				</ul>
				<p>各データは下記内容でまとめられています。<br />
				ＢｔｏＣの新規顧客　〇%から〇〇%<br />
				ＢｔｏＢの新規顧客　〇%から〇〇%<br />
				ＢｔｏＣの既存顧客　〇%から〇〇%（宛先を厳選しています）<br />
				ＢｔｏＢの既存顧客　〇%から〇〇%（宛先を厳選しています）</p>

				<div class="dwn_checklist mt50 mb60">
					<img class="urawaza" src="/images/dwn/hannouritu_checklist_ttl.png" alt="特に反応率の良いDMの7つの特徴">
					<ol>
						<li><p>新規でも○○が限定できている</p></li>
						<li><p>○○に秀逸</p></li>
						<li><p>ある理由がある</p></li>
						<li><p>○○をしている</p></li>
						<li><p>○○に絶妙</p></li>
				...
				<div class="btn_dm_flam"><div class="btn_dm">2010年と2017年の変化</div></div>
				<div class="dwn_heart">
					<ul>
						<li><span>○○を出し売上を伸ばす会社が増えた</span></li>
						<li><span>お客様が○○の比較検討をすることが増えた</span></li>
						<li><span>○○の付加価値で購入を決定するパターンが増えてきた</span></li>
						<li><span>○○が短くなった</span></li>
						<li><span>DMだけでなく○○が重要になってきた</span></li>
					</ul>
					<ul>
						<li><span>お客様がDMを見て○○になった</span></li>
						<li><span>DMから○○の購入が増えた</span></li>
						<li><span>ネット中心の会社（中小企業）の○○が増えた</span></li>
						<li><span>○○での消費行動が増えた</span></li>
						<li><span>売込DMよりも、○○が効果を上げている</span></li>
					</ul>
				</div>

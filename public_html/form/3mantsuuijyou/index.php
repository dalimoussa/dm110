...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="ja" lang="ja">
	<head>
		...
		<title>3万通以上発送代行 お見積り DM(ダイレクトメール)発送代行センター</title>
		<meta name="Keywords" content="御見積り,発送代行,3万通以上発送, 3万通以発送代行" />
		<meta name="Description" content="DM発送代行センターの3万通以発送代行の御見積りのページです。" />
	...
	<body class="mail_form" id="mantsuuijyou3">
		...
		<div id="container">
			...
			<div id="main" class="form_index">
				...
				<div id="main-in">
					...
					<!--メインイメージ-->
					<div id="main-image1">
						<img src="/images/common/visual_form_3mantsuuijyou.jpg" />
					</div>
					<!--/メインイメージ-->
					...
					<ul id="breadcrumb" itemscope itemtype="https://schema.org/BreadcrumbList">
						...
						<li itemprop="itemListElement" itemscope itemtype="https://schema.org/ListItem"><span itemprop="name">3万通以上発送代行 お見積り</span><meta itemprop="position" content="2" /></li>
					</ul>
					...
					<div id="main-contents3">
						...
						<!--conts-->
						<h2 class="ttl01_wide">3万通以上発送代行 お見積り</h2>
							...
							<table>
								...
								<tr>
									...
									<td class="print">
										...
										<div>
											<label><input type="checkbox" name="kinds2" value="小冊子"<?php if ($form->get('kinds2')) : ?> checked="checked"<?php endif; ?> />小冊子</label>
										</div>
										<div>
											<label><input type="checkbox" name="kinds3" value="カタログ"<?php if ($form->get('kinds3')) : ?> checked="checked"<?php endif; ?> />カタログ</label>
										</div>
										<div>
											<label><input type="checkbox" name="kinds4" value="その他"<?php if ($form->get('kinds4')) : ?> checked="checked"<?php endif; ?> />その他</label>
										</div>
									</td>
								</tr>
								<tr>

...
<?php if ($form->get('print2_size')) : ?>
								<tr>
									<th></th>
									<td>
										サイズ：<?php echo e($form->get('print2_size')); ?>　／　紙の色：<?php echo e($form->get('print2_color')); ?>　／　片面・両面：<?php echo e($form->get('print2_method')); ?>　／　印刷枚数：<?php echo e($form->get('print2_num')); ?>
									</td>
								</tr>
<?php endif; ?>
<?php if ($form->get('print3_size')) : ?>
								<tr>
									<th></th>
									<td>
										サイズ：<?php echo e($form->get('print3_size')); ?>　／　紙の色：<?php echo e($form->get('print3_color')); ?>　／　片面・両面：<?php echo e($form->get('print3_method')); ?>　／　印刷枚数：<?php echo e($form->get('print3_num')); ?>
									</td>
								</tr>
<?php endif; ?>
<?php if ($form->get('print4_size')) : ?>
								<tr>
									<th></th>
									<td>
										サイズ：<?php echo e($form->get('print4_size')); ?>　／　紙の色：<?php echo e($form->get('print4_color')); ?>　／　片面・両面：<?php echo e($form->get('print4_method')); ?>　／　印刷枚数：<?php echo e($form->get('print4_num')); ?>
									</td>
								</tr>
<?php endif; ?>
<?php if ($form->get('print5_size')) : ?>
								<tr>
									<th></th>
									<td>
										サイズ：<?php echo e($form->get('print5_size')); ?>　／　紙の色：<?php echo e($form->get('print5_color')); ?>　／　片面・両面：<?php echo e($form->get('print5_method')); ?>　／　印刷枚数：<?php echo e($form->get('print5_num')); ?>
									</td>
								</tr>
<?php endif; ?>

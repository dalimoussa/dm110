...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="ja" lang="ja">
	<head>
		...
		<title>黒一色印刷（モノクロ印刷）お見積り　DM(ダイレクトメール)発送代行センター</title>
		<meta name="Keywords" content="モノクロ印刷,単色印刷,白黒印刷 " />
		<meta name="Description" content="DM発送代行センターの単色印刷（モノクロ印刷）の御見積りのページです。" />
	...
	<body class="mail_form" id="eninsatu2">
			...
			<div id="main" class="form_index">
				...
				<div id="main-in">
					...
					<ul id="breadcrumb" itemscope itemtype="https://schema.org/BreadcrumbList">
						...
						<li itemprop="itemListElement" itemscope itemtype="https://schema.org/ListItem"><span itemprop="name">黒一色印刷（モノクロ印刷）お見積り</span><meta itemprop="position" content="2" /></li>
					</ul>
					...
					<div id="main-contents3">
						...
						<!--conts-->
						<h2 class="ttl01_wide">2円印刷（A4黒一色印刷）お見積り</h2>
...
<?php endif; ?>
								...
								<tr>
									...
									<td class="print">
										...
										<div>
											...
											<?php if ($form->is_error('print1_color')) : ?><span class="error">紙の色は必須です</span><?php endif; ?>
										</div>
										<div>
											<span>片面・両面</span>
									...
									<td class="print">
										...
										<div>
											...
											<select name="print2_color">
												<option value="">紙の色</option>
												<option value="白色"<?php if ($form->get('print2_color') == '白色' ) : ?> selected="selected"<?php endif; ?>>白色</option>
												<option value="クリーム色"<?php if ($form->get('print2_color') == 'クリーム色' ) : ?> selected="selected"<?php endif; ?>>クリーム色</option>
												<option value="ピンク色"<?php if ($form->get('print2_color') == 'ピンク色' ) : ?> selected="selected"<?php endif; ?>>ピンク色</option>
												<option value="若草色"<?php if ($form->get('print2_color') == '若草色' ) : ?> selected="selected"<?php endif; ?>>若草色</option>
											</select>
										</div>
										<div>
											<span>片面・両面</span>
									...
									<td class="print">
										...
										<div>
											...
											<select name="print3_color">
												<option value="">紙の色</option>
												<option value="白色"<?php if ($form->get('print3_color') == '白色' ) : ?> selected="selected"<?php endif; ?>>白色</option>
												<option value="クリーム色"<?php if ($form->get('print3_color') == 'クリーム色' ) : ?> selected="selected"<?php endif; ?>>クリーム色</option>
												<option value="ピンク色"<?php if ($form->get('print3_color') == 'ピンク色' ) : ?> selected="selected"<?php endif; ?>>ピンク色</option>
												<option value="若草色"<?php if ($form->get('print3_color') == '若草色' ) : ?> selected="selected"<?php endif; ?>>若草色</option>
											</select>
										</div>
										<div>
											<span>片面・両面</span>
									...
									<td class="print">
										...
										<div>
											...
											<select name="print4_color">
												<option value="">紙の色</option>
												<option value="白色"<?php if ($form->get('print4_color') == '白色' ) : ?> selected="selected"<?php endif; ?>>白色</option>
												<option value="クリーム色"<?php if ($form->get('print4_color') == 'クリーム色' ) : ?> selected="selected"<?php endif; ?>>クリーム色</option>
												<option value="ピンク色"<?php if ($form->get('print4_color') == 'ピンク色' ) : ?> selected="selected"<?php endif; ?>>ピンク色</option>
												<option value="若草色"<?php if ($form->get('print4_color') == '若草色' ) : ?> selected="selected"<?php endif; ?>>若草色</option>
											</select>
										</div>
										<div>
											<span>片面・両面</span>
									...
									<td class="print">
										...
										<div>
											...
											<select name="print5_color">
												<option value="">紙の色</option>
												<option value="白色"<?php if ($form->get('print5_color') == '白色' ) : ?> selected="selected"<?php endif; ?>>白色</option>
												<option value="クリーム色"<?php if ($form->get('print5_color') == 'クリーム色' ) : ?> selected="selected"<?php endif; ?>>クリーム色</option>
												<option value="ピンク色"<?php if ($form->get('print5_color') == 'ピンク色' ) : ?> selected="selected"<?php endif; ?>>ピンク色</option>
												<option value="若草色"<?php if ($form->get('print5_color') == '若草色' ) : ?> selected="selected"<?php endif; ?>>若草色</option>
											</select>
										</div>
										<div>
											<span>片面・両面</span>
				...
				<?php include($_SERVER['DOCUMENT_ROOT'])."/commoninc_newgo_top.html"; ?>

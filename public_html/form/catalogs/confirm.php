		...
		<div id="container">
			...
			<div id="main" class="form_index">
				...
				<div id="main-in">
					...
					<!--メインイメージ-->
					<div id="main-image1">
						<img src="/images/common/visual_form_catalogs.jpg" />
					</div>
					<!--/メインイメージ--> 
...
<?php endif; ?>
								...
								<tr>
									...
									<td><?php echo e($form->get('pages')); ?> ページ</td>
								</tr>
								<tr>
									<th>
										<em>封入物の厚さ</em>
									...
									<td><?php echo e($form->get('thickness')); ?> mm</td>
								</tr>
								<tr>
									<th>
										<em>封入物の重さ</em>
									...
									<td><?php echo e($form->get('wight')); ?> g</td>
								</tr>
								<tr>
									<th>
										<em>発送予定の数</em>

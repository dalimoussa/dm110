...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="ja" lang="ja">
	<head>
		...
		<title>DM発送の資料請求フォーム</title>
		<meta name="keywords" content="DM発送代行,資料請求" />
		<meta name="description" content="印刷物、封筒、透明封筒見本、その他DM発送に関しての資料を送らせていただきます。" />
	...
	<body class="mail_form" id="request">
			...
			<div id="main" class="form_index">
				...
				<div id="main-in">
					...
					<ul id="breadcrumb" itemscope itemtype="https://schema.org/BreadcrumbList">
						...
						<li itemprop="itemListElement" itemscope itemtype="https://schema.org/ListItem"><span itemprop="name">資料請求</span><meta itemprop="position" content="2" /></li>
					</ul>

					<!--▽メインコンテンツ-->
					<div id="main-contents3">

						<h2 class="ttl01_wide">資料請求</h2>
...
<?php endif; ?>
						...
						<form method="post" role="form" action="#main-contents3">
							...
							<div class="m20-t al-c" id="request_inquiry">
								<p>
									<strong>電話でのお問合せ　0561-37-2027　担当：加藤<br />【営業時間/9:00～18:00　休日/土日祝祭日】</strong><br />
									資料は営業日の午後4時30分までにお申込みいただけると申込み当日にメール便にて発送いたします。<br />
									下記の封筒でお送りします。<br />
									<img src="/images/common/pic_request.png" alt="資料請求用の封筒" /><br />
									<span>角２紙封筒</span>
									<br /><br />

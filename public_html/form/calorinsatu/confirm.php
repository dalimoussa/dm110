						...
						<form method="post" role="form" action="#main-contents3">
							<table>
								...
								<tr>
									...
									<td>
										サイズ：<?php echo e($form->get('print1_size')); ?>　／　片面・両面：<?php echo e($form->get('print1_method')); ?>　／　印刷枚数：<?php echo e($form->get('print1_num')); ?>
									</td>
								</tr>
...
<?php if ($form->get('print3_size')) : ?>
								<tr>
									<th></th>
									<td>
										サイズ：<?php echo e($form->get('print3_size')); ?>　／　片面・両面：<?php echo e($form->get('print3_method')); ?>　／　印刷枚数：<?php echo e($form->get('print3_num')); ?>
									</td>
								</tr>
<?php endif; ?>
<?php if ($form->get('print4_size')) : ?>
								<tr>
									<th></th>
									<td>
										サイズ：<?php echo e($form->get('print4_size')); ?>　／　片面・両面：<?php echo e($form->get('print4_method')); ?>　／　印刷枚数：<?php echo e($form->get('print4_num')); ?>
									</td>
								</tr>
<?php endif; ?>
<?php if ($form->get('print5_size')) : ?>
								<tr>
									<th></th>
									<td>
										サイズ：<?php echo e($form->get('print5_size')); ?>　／　片面・両面：<?php echo e($form->get('print5_method')); ?>　／　印刷枚数：<?php echo e($form->get('print5_num')); ?>
									</td>
								</tr>
<?php endif; ?>

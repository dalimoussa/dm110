			...
			<div id="main" class="form_index">
				...
				<div id="main-in">
					...
					<ul id="breadcrumb" itemscope itemtype="https://schema.org/BreadcrumbList">
						...
						<li itemprop="itemListElement" itemscope itemtype="https://schema.org/ListItem"><span itemprop="name">A4透明封筒注文フォーム</span><meta itemprop="position" content="2" /></li>
					</ul>
					...
					<div id="main-contents3">
						...
						<!--conts-->
						<h2 class="ttl01_wide">A4透明封筒ご注文フォーム</h2>
						<form method="post" role="form" action="#main-contents3">
							<table>
								...
								<tr<?php if ($form->is_error('comapny_name_kana')) : ?> has-error<?php endif; ?>>
									<th><em>会社名（フリガナ）</em></th>
									<td><?php echo e($form->get('comapny_name_kana')); ?></td>
								</tr>
								...
								<tr<?php if ($form->is_error('name_kana')) : ?> has-error<?php endif; ?>>
									<th>
										<em>担当者様名（フリガナ）</em>
									</th>
									<td><?php echo e($form->get('name_kana')); ?></td>
								</tr>
								<tr<?php if ($form->is_error('name')) : ?> has-error<?php endif; ?>>
									<th>

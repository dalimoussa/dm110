...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="ja" lang="ja">
	<head>
		...
		<title>透明封筒</title>
		<meta name="Keywords" content="透明封筒,A4透明封筒" />
		<meta name="Description" content="透明封筒だけの注文はお受けします。当社にて発送依頼の場合んは発送件数に関係なく一枚＠4円にて販売します" />
	...
	<body class="mail_form" id="toumeifuutou">
		...
		<div id="container">
			...
			<div id="main" class="form_index">
				...
				<div id="main-in">
					...
					<!--メインイメージ-->
					<div id="main-image1">
						<img src="/images/common/visual_form_toumeifuutou.jpg" />
					</div>
					<!--/メインイメージ-->
					...
					<ul id="breadcrumb" itemscope itemtype="https://schema.org/BreadcrumbList">
						...
						<li itemprop="itemListElement" itemscope itemtype="https://schema.org/ListItem"><span itemprop="name">A4透明封筒注文</span><meta itemprop="position" content="2" /></li>
					</ul>
					...
					<div id="main-contents3">
						...
						<!--conts-->
						<h2 class="ttl01_wide">A4透明封筒注文</h2>
						...
						<form method="post" role="form" action="#main-contents3">
							<table>
								<tr>
									...
									<td>
										<input type="text" name="comapny_name" class="middle" value="<?php echo $form->get('comapny_name'); ?>" />
								...
								<tr>
									...
									<td>
										<input type="text" name="name" class="middle" value="<?php echo $form->get('name'); ?>" />
								...
								<tr>
									...
									<td>
										<input type="text" name="email"  class="middle" value="<?php echo $form->get('email'); ?>" />
								...
								<tr>
									...
									<td>
										<input type="text" name="zip" class="narrow" value="<?php echo $form->get('zip'); ?>" onkeyup="AjaxZip3.zip2addr(this,'','pref','address1','address2');" />
										<span class="example">
								...
								<tr>
									...
									<td>
										...
										<div>
											<span>市区町村</span>
											<input type="text" name="address1" class="middle" value="<?php echo $form->get('address1'); ?>" />
											<?php echo $form->error('address1', '<span class="error">', '</span>'); ?>
										</div>

										<div>
											<span>丁目番地</span>
											<input type="text" name="address2" class="wide" value="<?php echo $form->get('address2'); ?>" />
								...
								<tr>
									...
									<td>
										<input type="text" name="tel" class="middle" value="<?php echo $form->get('tel'); ?>" />
								...
								<tr>
									...
									<td>
										<input type="text" name="fax" class="middle" value="<?php echo $form->get('fax'); ?>" />
									</td>
								</tr>
								<tr>
									<th>
										<em>ご注文数</em>
										<span class="must">必須</span>
										<span class="english">number of the orders</span>
									</th>
									<td>
										<select id="number" name="number">
											<option value="">【選択して下さい】</option>
											<option value="500枚　4,752円"<?php if ($form->get('number') == '500枚　4,752円' ) : ?> selected="selected"<?php endif; ?>>500枚　4,752円</option>
											<option value="1000枚　6,696円"<?php if ($form->get('number') == '1000枚　6,696円' ) : ?> selected="selected"<?php endif; ?>>1000枚　6,696円</option>
											<option value="3000枚　17,820円"<?php if ($form->get('number') == '3000枚　17,820円' ) : ?> selected="selected"<?php endif; ?>>3000枚　17,820円</option>
											<option value="5000枚　25,920円"<?php if ($form->get('number') == '5000枚　25,920円' ) : ?> selected="selected"<?php endif; ?>>5000枚　25,920円</option>
											<option value="10000枚　47,520円"<?php if ($form->get('number') == '10000枚　47,520円' ) : ?> selected="selected"<?php endif; ?>>10000枚　47,520円</option>
											<option value="30000枚　132,840円"<?php if ($form->get('number') == '30000枚　132,840円' ) : ?> selected="selected"<?php endif; ?>>30000枚　132,840円</option>
										</select><br />
										※送料、代金引換手数料込み（消費税は含みます）
										<?php echo $form->error('number', '<span class="error">', '</span>'); ?>
									</td>
								</tr>
								<tr>
									<th>
										<em>案件内容・現状・お困りごと・<br />条件などをお書き下さい</em>
										<span class="english">inquiry body</span>
									</th>
									<td>
										<textarea name="comment"><?php echo $form->get('comment'); ?></textarea>
										<p>※２万枚以上で「ご注文枚数」に記載がない枚数が必要な場合、こちらに枚数をお書き下さい。<br />
											料金をメール等にて連絡させていただきます。</p>
									</td>
								</tr>
							</table>
							...
							<div class="m20-t al-c">
								<p>
									<strong>お急ぎの場合は必ずお電話にて確認ください。<br />
										TEL 0561-37-2027　担当：神戸・長屋</strong>
									<br /><br />
									下記同意の上、「確認画面へ」ボタンを押してください。</p>
							</div>

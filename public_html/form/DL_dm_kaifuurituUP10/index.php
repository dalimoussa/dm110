...
<body class="kaifuurituup" id="request">
	...
	<div id="container">
		<div id="main" class="form_index"><div id="main-in">
			<ul id="breadcrumb" itemscope itemtype="https://schema.org/BreadcrumbList">
				...
				<li itemprop="itemListElement" itemscope itemtype="https://schema.org/ListItem"><span itemprop="name">DM開封率を上げる実例10選</span><meta itemprop="position" content="3" /></li>
			</ul>
...
<?php endif; ?>
				...
				<a href="#free_dwnload"><div id="dwn_mv"><div id="dwn_mv_in">
					<ul>
						<li class="sp_hidden"><img src="/images/dwn/kaifuuritu_mv1.png" alt="ユーザーの心の動きや裏技を駆使してDM開封率を上げるポイントを教えます！"></li>
						<li><img src="/images/dwn/kaifuuritu_mv2.png" alt="DM開封率を上げる実例10選"></li>
						<li><img src="/images/dwn/kaifuuritu_mv3.png" alt="pdf資料"></li>
					</ul>
				</div></div></a>
				<p class="sp_view mb30"><img src="/images/dwn/dwn_mv_kyotsu.png" alt="無料ダウンロード"></p>
				<p class="sp_view">ユーザーの心の動きや裏技を駆使して<br />DM開封率を上げるポイントを教えます！</p>

				<h1 class="ttl01_wide">DM開封率を上げる実例10選</h1>
				<p class="mb60">時間とお金をかけて必死に作ったDMも内容を確認もされずに捨てられてはたまりません。<br />
					DMを送る場合には避けて通れない開封率。<br />
					少しでも開封率を上げるための方法を10個紹介します。</p>

				<div class="btn_dm_flam"><div class="btn_dm">DMを開封されるまでの心の動き</div></div>
				<p class="mb30 al_center">まずは心の動きを追ってみることが大事です。</p>
				<div class="dwn_heart">
					<ul>
						<li><span>郵送物の何を確認するか？</span></li>
						<li><span>郵送物を仕分ける基準</span></li>
						<li><span>誰が郵送物を受け取るか</span></li>
						<li><span>差出人で判断することは？</span></li>
					</ul>
					<ul>
						<li><span>開封するか迷う場合</span></li>
						<li><span>送付物を捨てる場合</span></li>
						<li><span>開封される郵送物の条件は？</span></li>
						<li><span>捨てられない郵送物にするにはどのような条件であれば良いか？</span></li>
					</ul>
				</div>

				<div class="dwn_checklist mt50">
					<img class="urawaza" src="/images/dwn/checklist_ttl.png" alt="DM開封の裏技">
					<ol>
						<li><p>無料で送り、必ず開封される方法</p></li>
						<li><p>宛名・差出人は○○○</p></li>
						<li><p>○○切手を○○貼り</p></li>
						<li><p>封筒には○○と書く</p></li>
						<li><p>○○を押す</p></li>
						<li><p>「○○に関する○○を同梱します」と書く</p></li>
						<li><p>○○封筒か○○の封筒　文字は○○色で○○を使う</p></li>
						<li><p>DMは○○の中にも入れる</p></li>
						<li><p>最終手段は○○で送る</p></li>
						<li><p>文字は○○色で○○を使う</p></li>
					</ol>
				</div>

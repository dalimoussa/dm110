...
//	'error_'.\Upload::UPLOAD_ERR_INI_SIZE				=> 'アップロードファイルのサイズが2MBを超えています',
	'error_'.\Upload::UPLOAD_ERR_INI_SIZE				=> 'ファイルサイズがオーバーしています。',
//	'error_'.\Upload::UPLOAD_ERR_FORM_SIZE				=> 'アップロードファイルのサイズが2MBを超えています',
	'error_'.\Upload::UPLOAD_ERR_FORM_SIZE				=> 'ファイルサイズがオーバーしています。',
...
//	'error_'.\Upload::UPLOAD_ERR_MAX_SIZE				=> 'アップロードファイルのサイズが2MBを超えています',
	'error_'.\Upload::UPLOAD_ERR_MAX_SIZE				=> 'ファイルサイズがオーバーしています。',

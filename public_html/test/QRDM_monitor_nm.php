...
//	$og_image    = 'cover.jpg';
	$canonical   = 'https://test.dm110.jp/QRDM_monitor_nm';
...
<main>
	...
	<section id="m01">
		...
		<ul class="list-circle u-ml30">
			<li>右記QRコードまたは下記URLの「お問合せ」から<br>　<a href="https://test.dm110.jp/form/contact/">https://test.dm110.jp/form/contact/</a><br>フォームの「ご用件をお書きください」に<br>「<strong class="underline-yellow">QRDM無料モニターの件</strong>」と入力して送信ください。</li>
		...
		<div class="link-box-2cu u-mb30">
			...
			<div class="link-button u-pa10"><a href="https://test.dm110.jp/step_mail" style="margin:auto">ステップメールの作り方</a></div>
		</div>

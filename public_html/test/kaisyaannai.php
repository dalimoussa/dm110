...
//	$og_image    = 'cover.jpg';
	$canonical   = 'https://test.dm110.jp/kaisyaannai';
...
*/ ?>
	...
	<section id="m01">
		...
		<dl class="u-dl">
			...
			<dt>URL</dt>
			<dd><a href="https://test.dm110.jp">https://test.dm110.jp</a></dd>
			...
			<dt>取引実績</dt>
			<dd><a href="https://test.dm110.jp/torihiki_jisseki.htm">取引実績はこちら</a></dd>
...
-->
		...
		<div id="ceo" class="uk-flex uk-flex-wrap uk-flex-center">
			...
			<div>
				...
				<div class="link-button u-pa10"><a href="https://test.dm110.jp/DM_kakumei">DMトラッカー詳細</a></div>
	...
	<section id="m04">
		...
		<p>見積を返信した担当者が最後まで担当します。<br>
			...
			非常時も焦らずに対応できます。</p>
		<div class="link-button u-pa10"><a href="https://test.dm110.jp/koe/">お客様の声をご確認ください</a></div>

...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="ja" lang="ja">
	<head>
		...
		<title>「DMを安く送る方法」小冊子 申込フォーム</title>
			...
			<div id="main" class="form_index">
				...
				<div id="main-in">
					...
					<ul id="breadcrumb" itemscope itemtype="https://schema.org/BreadcrumbList">
						...
						<li itemprop="itemListElement" itemscope itemtype="https://schema.org/ListItem"><span itemprop="name">「DMを安く送る方法」小冊子 申込</span><meta itemprop="position" content="2" /></li>
					</ul>

					<!--▽メインコンテンツ-->
					<div id="main-contents3">

						<h2 class="ttl01_wide">「DMを安く送る方法」小冊子 申込</h2>

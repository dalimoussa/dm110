							...
							<table>
								...
								<tr>
									...
									<td>
										...
										<span class="example">
											<a href="http://www.post.japanpost.jp/zipcode/" target="_blank">郵便番号を調べる</a> 半角英数字のみ　例） 123-4567、1234567<br>
...
?>
							...
							<div id="agree">
								<span class="must">必須</span> <label><input type="checkbox" name="agree"<?php if ($form->get('agree')) : ?> checked="checked"<?php endif; ?> /> プライバシーポリシー・規約に同意する</label>
...
?>
								...
								<button type="submit" class="btn btn-form btn-large">削減額を確認する<br />【ディスカウント見積を受け取る】</button>
								<p class="m10-t red">会社への営業電話はしません</p>
							</div>

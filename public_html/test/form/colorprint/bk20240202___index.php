...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="ja" lang="ja">
	<head>
		...
		<title>カラー印刷　お見積り　DM(ダイレクトメール)発送代行センター</title>
		<meta name="Keywords" content="御見積り,カラー両面印刷,カラー印刷,4C印刷" />
		<meta name="Description" content="DM発送代行センターのカラー印刷、御見積りページです。" />
	...
	<body class="mail_form" id="colorprint">
		...
		<div id="container">
			...
			<div id="main" class="form_index">
				...
				<div id="main-in">
					...
					<!--メインイメージ-->
					<div id="main-image1">
						<img src="/images/common/visual_form_2eninsatu.jpg" alt="" />
					</div>
					<!--/メインイメージ--> 
					...
					<ul id="breadcrumb" itemscope itemtype="https://schema.org/BreadcrumbList">
						...
						<li itemprop="itemListElement" itemscope itemtype="https://schema.org/ListItem"><span itemprop="name">カラー印刷（A3・A4・B4・B5）お見積り</span><meta itemprop="position" content="2" /></li>
					</ul>
					...
					<div id="main-contents3">
						...
						<!--conts-->
						<h2 class="ttl01_wide">カラー印刷（A3・A4・B4・B5）フォーム</h2>
							...
							<table>
								...
								<tr>
									<th>
										<em>カラー印刷</em>
										<span class="must">必須</span>
										<span class="english">all in printing color</span>
									</th>
									<td class="print">
										<div>
											<span>サイズ</span>
											<select id="print1_size" name="print1_size">
												...
												<option value="B4"<?php if ($form->get('print1_size') == 'B4' ) : ?> selected="selected"<?php endif; ?>>B4</option>
												<option value="B5"<?php if ($form->get('print1_size') == 'B5' ) : ?> selected="selected"<?php endif; ?>>B5</option>
											</select>
											<?php if ($form->is_error('print1_size')) : ?><span class="error">サイズは必須です</span><?php endif; ?>
										</div>
										<div>
											<span>紙の種類</span>
											<select id="print1_color" name="print1_color">
												<option value="">紙の種類</option>
												<option value="コート紙 90kg"<?php if ($form->get('print1_color') == 'コート紙 90kg' ) : ?> selected="selected"<?php endif; ?>>コート紙 90kg</option>
												<option value="コート紙 110kg"<?php if ($form->get('print1_color') == 'コート紙 110kg' ) : ?> selected="selected"<?php endif; ?>>コート紙 110kg</option>
												<option value="コート紙 135kg"<?php if ($form->get('print1_color') == 'コート紙 135kg' ) : ?> selected="selected"<?php endif; ?>>コート紙 135kg</option>
												<option value="マットコート紙 90kg"<?php if ($form->get('print1_color') == 'マットコート紙 90kg' ) : ?> selected="selected"<?php endif; ?>>マットコート紙 90kg</option>
												<option value="マットコート紙 110kg"<?php if ($form->get('print1_color') == 'マットコート紙 110kg' ) : ?> selected="selected"<?php endif; ?>>マットコート紙 110kg</option>
												<option value="マットコート紙 135kg"<?php if ($form->get('print1_color') == 'マットコート紙 135kg' ) : ?> selected="selected"<?php endif; ?>>マットコート紙 135kg</option>
											</select>
											<?php if ($form->is_error('print1_color')) : ?><span class="error">紙の種類は必須です</span><?php endif; ?>
										</div>
										<div>
											<span>片面・両面</span>
											...
											<?php if ($form->is_error('print1_method')) : ?><span class="error">片面・両面は必須です</span><?php endif; ?>
										</div>
										<div>
											<span>印刷枚数</span>
											<input type="text" name="print1_num" class="ex_narrow" value="<?php echo e($form->get('print1_num')); ?>" />
											<?php if ($form->is_error('print1_num')) : ?><span class="error">印刷枚数は必須です</span><?php endif; ?>
										</div>
									</td>
								</tr>
								<tr>
									...
									<td class="print">
										<div>
											...
											<select name="print2_size">
												...
												<option value="B4"<?php if ($form->get('print2_size') == 'B4' ) : ?> selected="selected"<?php endif; ?>>B4</option>
												<option value="B5"<?php if ($form->get('print2_size') == 'B5' ) : ?> selected="selected"<?php endif; ?>>B5</option>
											</select>
										</div>
										<div>
											<span>紙の種類</span>
											<select name="print2_color">
												<option value="">紙の種類</option>
												<option value="コート紙 90kg"<?php if ($form->get('print2_color') == 'コート紙 90kg' ) : ?> selected="selected"<?php endif; ?>>コート紙 90kg</option>
												<option value="コート紙 110kg"<?php if ($form->get('print2_color') == 'コート紙 110kg' ) : ?> selected="selected"<?php endif; ?>>コート紙 110kg</option>
												<option value="コート紙 135kg"<?php if ($form->get('print2_color') == 'コート紙 135kg' ) : ?> selected="selected"<?php endif; ?>>コート紙 135kg</option>
												<option value="マットコート紙 90kg"<?php if ($form->get('print2_color') == 'マットコート紙 90kg' ) : ?> selected="selected"<?php endif; ?>>マットコート紙 90kg</option>
												<option value="マットコート紙 110kg"<?php if ($form->get('print2_color') == 'マットコート紙 110kg' ) : ?> selected="selected"<?php endif; ?>>マットコート紙 110kg</option>
												<option value="マットコート紙 135kg"<?php if ($form->get('print2_color') == 'マットコート紙 135kg' ) : ?> selected="selected"<?php endif; ?>>マットコート紙 135kg</option>
											</select>
										</div>
										<div>
											<span>片面・両面</span>
										...
										<div>
											<span>印刷枚数</span>
											<input type="text" name="print2_num" class="ex_narrow" value="<?php echo e($form->get('print2_num')); ?>" />
										</div>
									</td>
								</tr>
								...
								<tr>
									...
									<td class="print">
										<div>
											<span>サイズ</span>
											<select name="print3_size">
												<option value="">サイズ</option>
												<option value="A4"<?php if ($form->get('print3_size') == 'A4' ) : ?> selected="selected"<?php endif; ?>>A4</option>
												<option value="A3"<?php if ($form->get('print3_size') == 'A3' ) : ?> selected="selected"<?php endif; ?>>A3</option>
												<option value="B4"<?php if ($form->get('print3_size') == 'B4' ) : ?> selected="selected"<?php endif; ?>>B4</option>
												<option value="B5"<?php if ($form->get('print3_size') == 'B5' ) : ?> selected="selected"<?php endif; ?>>B5</option>
											</select>
										</div>
										<div>
											<span>紙の種類</span>
											<select name="print3_color">
												<option value="">紙の種類</option>
												<option value="コート紙 90kg"<?php if ($form->get('print3_color') == 'コート紙 90kg' ) : ?> selected="selected"<?php endif; ?>>コート紙 90kg</option>
												<option value="コート紙 110kg"<?php if ($form->get('print3_color') == 'コート紙 110kg' ) : ?> selected="selected"<?php endif; ?>>コート紙 110kg</option>
												<option value="コート紙 135kg"<?php if ($form->get('print3_color') == 'コート紙 135kg' ) : ?> selected="selected"<?php endif; ?>>コート紙 135kg</option>
												<option value="マットコート紙 90kg"<?php if ($form->get('print3_color') == 'マットコート紙 90kg' ) : ?> selected="selected"<?php endif; ?>>マットコート紙 90kg</option>
												<option value="マットコート紙 110kg"<?php if ($form->get('print3_color') == 'マットコート紙 110kg' ) : ?> selected="selected"<?php endif; ?>>マットコート紙 110kg</option>
												<option value="マットコート紙 135kg"<?php if ($form->get('print3_color') == 'マットコート紙 135kg' ) : ?> selected="selected"<?php endif; ?>>マットコート紙 135kg</option>
											</select>
										</div>
										<div>
											<span>片面・両面</span>
											<select name="print3_method">
												<option value="">印刷方法</option>
												<option value="片面"<?php if ($form->get('print3_method') == '片面' ) : ?> selected="selected"<?php endif; ?>>片面</option>
												<option value="両面"<?php if ($form->get('print3_method') == '両面' ) : ?> selected="selected"<?php endif; ?>>両面</option>
											</select>
										</div>
										<div>
											<span>印刷枚数</span>
											<input type="text" name="print3_num" class="ex_narrow" value="<?php echo e($form->get('print3_num')); ?>" />
										</div>
									</td>
								</tr>
								...
								<tr>
									...
									<td class="print">
										<div>
											<span>サイズ</span>
											<select name="print4_size">
												<option value="">サイズ</option>
												<option value="A4"<?php if ($form->get('print4_size') == 'A4' ) : ?> selected="selected"<?php endif; ?>>A4</option>
												<option value="A3"<?php if ($form->get('print4_size') == 'A3' ) : ?> selected="selected"<?php endif; ?>>A3</option>
												<option value="B4"<?php if ($form->get('print4_size') == 'B4' ) : ?> selected="selected"<?php endif; ?>>B4</option>
												<option value="B5"<?php if ($form->get('print4_size') == 'B5' ) : ?> selected="selected"<?php endif; ?>>B5</option>
											</select>
										</div>
										<div>
											<span>紙の種類</span>
											<select name="print4_color">
												<option value="">紙の種類</option>
												<option value="コート紙 90kg"<?php if ($form->get('print4_color') == 'コート紙 90kg' ) : ?> selected="selected"<?php endif; ?>>コート紙 90kg</option>
												<option value="コート紙 110kg"<?php if ($form->get('print4_color') == 'コート紙 110kg' ) : ?> selected="selected"<?php endif; ?>>コート紙 110kg</option>
												<option value="コート紙 135kg"<?php if ($form->get('print4_color') == 'コート紙 135kg' ) : ?> selected="selected"<?php endif; ?>>コート紙 135kg</option>
												<option value="マットコート紙 90kg"<?php if ($form->get('print4_color') == 'マットコート紙 90kg' ) : ?> selected="selected"<?php endif; ?>>マットコート紙 90kg</option>
												<option value="マットコート紙 110kg"<?php if ($form->get('print4_color') == 'マットコート紙 110kg' ) : ?> selected="selected"<?php endif; ?>>マットコート紙 110kg</option>
												<option value="マットコート紙 135kg"<?php if ($form->get('print4_color') == 'マットコート紙 135kg' ) : ?> selected="selected"<?php endif; ?>>マットコート紙 135kg</option>
											</select>
										</div>
										<div>
											<span>片面・両面</span>
											<select name="print4_method">
												<option value="">印刷方法</option>
												<option value="片面"<?php if ($form->get('print4_method') == '片面' ) : ?> selected="selected"<?php endif; ?>>片面</option>
												<option value="両面"<?php if ($form->get('print4_method') == '両面' ) : ?> selected="selected"<?php endif; ?>>両面</option>
											</select>
										</div>
										<div>
											<span>印刷枚数</span>
											<input type="text" name="print4_num" class="ex_narrow" value="<?php echo e($form->get('print4_num')); ?>" />
										</div>
									</td>
								</tr>
								...
								<tr>
									...
									<td class="print">
										<div>
											<span>サイズ</span>
											<select name="print5_size">
												<option value="">サイズ</option>
												<option value="A4"<?php if ($form->get('print5_size') == 'A4' ) : ?> selected="selected"<?php endif; ?>>A4</option>
												<option value="A3"<?php if ($form->get('print5_size') == 'A3' ) : ?> selected="selected"<?php endif; ?>>A3</option>
												<option value="B4"<?php if ($form->get('print5_size') == 'B4' ) : ?> selected="selected"<?php endif; ?>>B4</option>
												<option value="B5"<?php if ($form->get('print5_size') == 'B5' ) : ?> selected="selected"<?php endif; ?>>B5</option>
											</select>
										</div>
										<div>
											<span>紙の種類</span>
											<select name="print5_color">
												<option value="">紙の種類</option>
												<option value="コート紙 90kg"<?php if ($form->get('print5_color') == 'コート紙 90kg' ) : ?> selected="selected"<?php endif; ?>>コート紙 90kg</option>
												<option value="コート紙 110kg"<?php if ($form->get('print5_color') == 'コート紙 110kg' ) : ?> selected="selected"<?php endif; ?>>コート紙 110kg</option>
												<option value="コート紙 135kg"<?php if ($form->get('print5_color') == 'コート紙 135kg' ) : ?> selected="selected"<?php endif; ?>>コート紙 135kg</option>
												<option value="マットコート紙 90kg"<?php if ($form->get('print5_color') == 'マットコート紙 90kg' ) : ?> selected="selected"<?php endif; ?>>マットコート紙 90kg</option>
												<option value="マットコート紙 110kg"<?php if ($form->get('print5_color') == 'マットコート紙 110kg' ) : ?> selected="selected"<?php endif; ?>>マットコート紙 110kg</option>
												<option value="マットコート紙 135kg"<?php if ($form->get('print5_color') == 'マットコート紙 135kg' ) : ?> selected="selected"<?php endif; ?>>マットコート紙 135kg</option>
											</select>
										</div>
										<div>
											<span>片面・両面</span>
											<select name="print5_method">
												<option value="">印刷方法</option>
												<option value="片面"<?php if ($form->get('print5_method') == '片面' ) : ?> selected="selected"<?php endif; ?>>片面</option>
												<option value="両面"<?php if ($form->get('print5_method') == '両面' ) : ?> selected="selected"<?php endif; ?>>両面</option>
											</select>
										</div>
										<div>
											<span>印刷枚数</span>
											<input type="text" name="print5_num" class="ex_narrow" value="<?php echo e($form->get('print5_num')); ?>" />
										</div>
									</td>
								</tr>
								<tr>

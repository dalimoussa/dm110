...
<head>
	...
	<title>無料でDMを送る方法</title>
	<meta name="keywords" content="DM,集客,ダウンロード,無料,発送方法,離脱率" />
	<meta name="description" content="無料でDMを送る方法です。実施されていない方が多いので是非お試しください。メディアボックスDM発送代行センター" />
	...
	<div id="container">
		<div id="main" class="form_index"><div id="main-in">
			<ul id="breadcrumb" itemscope itemtype="https://schema.org/BreadcrumbList">
				...
				<li itemprop="itemListElement" itemscope itemtype="https://schema.org/ListItem"><a href="https://test.dm110.jp/dwn_index.html" itemprop="item"><span itemprop="name">DM集客　無料ダウンロード</span></a><meta itemprop="position" content="2" /></li>
				<li itemprop="itemListElement" itemscope itemtype="https://schema.org/ListItem"><span itemprop="name">無料でDMを送る方法</span><meta itemprop="position" content="3" /></li>
			</ul>
...
<?php endif; ?>
				...
				<a href="#free_dwnload"><div id="dwn_mv"><div id="dwn_mv_in">
					<ul>
						<li class="sp_hidden"><img src="/images/dwn/muryou_mv1.png" alt="お客様へ紙媒体を利用することが増えているのをご存知ですか。無料で送る方法をご紹介。"></li>
						<li><img src="/images/dwn/muryou_mv2.png" alt="無料でDMを送る方法"></li>
						<li><img src="/images/dwn/muryou_mv3.png" alt="pdf資料"></li>
						</ul>
				</div></div></a>
				<p class="sp_view mb30"><img src="/images/dwn/dwn_mv_kyotsu.png" alt="無料ダウンロード"></p>
				<p class="sp_view">お客様へ紙媒体を利用することが増えているのをご存知ですか。<br />無料で送る方法をご紹介。</p>

				<h1 class="ttl01_wide">無料でDMを送る方法</h1>
				<p class="mb60">「DMを送るにはお金がかかるのでDMは考えていない」という方に、無料でDMを送る方法をお伝えします。<br />
					Eメール到達率低下やトラブルが多くなり、紙媒体を使いお客様と連絡を取ることが増えています。<br />
					特に重要な内容などはEメールの場合、「もらっていない」・「見ていない」のトラブルをよく聞きます。<br />
					DMや連絡事項を無料で送る方法がありますので活用ください。<br />
					まずは、DMを送っていなかったために大きな損失を招いた実例を紹介します。</p>

				<h2 class="ttl02">大きな損失</h2>
				<p class="mb30">これは実際にあったある機械卸の会社の例です。<br />お話を聞いたのはA社です。</p>
				<ul class="dwn_point_blue mb30">
					<li><span>機械卸会社A社はAAA商品・BBB商品を取り扱っています</span></li>
					<li><span>ライバル会社B社はAAA商品BBB商品とCCC商品を取り扱っています</span></li>
					<li><span>ライバル会社C社はBBB商品とCCC商品を取り扱っています</span></li>
					<li><span>ライバル会社D社はBBB商品とCCC商品を取り扱っています</span></li>
				</ul>
				<p class="mb20">A社のライバルはB社・C社・D社になります。</p>
				<p class="mb20">ある時、A社の取引先でもある山〇電機でB社が納品したBBB商品でトラブルが発生し、購入先を変更することになりました。<br />
					そこで山〇電機はB商品を扱っていると思われるB社C社D社を競合させD社にBBB商品を注文しました。</p>
				<p class="mb20">その時に取引があるA社には声がかかりませんでした。<br />
					理由はAAA商品を納品しているA社がBBB商品も扱っていることを知らなかったからです。<br />
					そして後日、D社の納入価格がA社よりも高いこともわかりました。</p>
				<p class="mb20">このような例が知らないところで起こっています。</p>
				<p class="mb60">第一に、お客様には自社商品を知っていただくことが大切です。<br />
					そのためにもお客様とは接触回数を増やし、自社商品を認知していただく必要があります。<br />
					営業がお客様と直接話すことが一番ですが、ことあるごとにDM やニュースレターで認知してもらうことが安上がりで効果的です。</p>

				<h2 class="ttl02">離脱率を12％減らした例</h2>
				<p class="mb20">新規客獲得は重要ですが、実は離脱客を減らすほうが効率的なことをご存知ですか？<br />
					顧客流出を5%減らせば25%の利益が増えるといわれています。<br />
					実際には、通常で毎年顧客流出は30%ぐらいはあるといわれています。</p>
				<p class="mb20">業種や業態により違いはあると思いますが、顧客流出はどうしても起こります。<br />
					ニュースレターを出し続けている会社に顧客流出率はどれくらい改善したかを教えていただいたことがあります。</p>
				<p class="mb20">この会社ではニュースレターを止めることは怖くてとてもできないそうです。<br />
					理由はニュースレターのおかげで顧客流出率が12％も減っているからです。<br />
					やはりお客様とのコミュニケーションはとても大切です。</p>
				<p class="mb20">また、お客様が個人の場合には、転居先の住所を知らせてもらう方法もあります。<br />
					この点は紙媒体の強いところです。</p>
				<p class="mb20">そこで、無料でDMを送る方法をご紹介したいと思います。<br />
					非常に簡単にできますので、ぜひ実行してみてください。</p>

		...
		<div id="container">
			...
			<div id="main" class="form_index">
				...
				<div id="main-in">
					...
					<!--メインイメージ-->
					<div id="main-image1">
						<img src="/images/common/visual_form_A4hagaki.jpg" alt="" />
					</div>
					<!--/メインイメージ--> 
						...
						<form method="post" role="form" action="#main-contents3">
							<table>
								...
								<tr>
									...
									<td class="list">
										<ul>
											<li><label><input type="radio" name="paper" value="135kgコート紙カラー"<?php if ($form->get('paper') == '135kgコート紙カラー' ) : ?> checked="checked"<?php endif; ?> />135kgコート紙カラー（紙質の関係で紙厚が薄くなります）</label></li>
											<li><label><input type="radio" name="paper" value="135kgマットコート紙カラー"<?php if ($form->get('paper') == '135kgマットコート紙カラー' ) : ?> checked="checked"<?php endif; ?> />135kgマットコート紙カラー（通常はこちらを選択してください）</label></li>
											<li><label><input type="radio" name="paper" value="135kg白黒"<?php if ($form->get('paper') == '135kg白黒' ) : ?> checked="checked"<?php endif; ?> />135kg白黒（FAX形式・記事風にしたい場合）</label></li>
											<li><label><input type="radio" name="paper" value="220kgカラー"<?php if ($form->get('paper') == '220kgカラー' ) : ?> checked="checked"<?php endif; ?> />220kgカラー（お客様に「永久保存版」として保存してもらいたい場合）</label></li>
										</ul>
										<?php echo $form->error('paper', '<span class="error">', '</span>'); ?>
									</td>
								</tr>

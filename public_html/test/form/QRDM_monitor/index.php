...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="ja" lang="ja">
	<head>
		...
		<title>QRコード申込フォームモニター用　DM発送代行センター（QRDM）</title>
			...
			<div id="main" class="form_index">
				...
				<div id="main-in">
					...
					<div id="main-contents3">
						...
						<h2 class="ttl01_wide">QRコード作成申込フォーム　モニター様</h2>
...
<?php endif; ?>
						<p class="m20"><strong class="big2 red01">封入物にQRコードを印刷する場合になります。</strong><br />
						※ 紙質はマット紙・上質紙になります。<br />
						※ QRコード印刷部分の空白は50mm×50mmが必要です。<br />
						※ DM発送前と後にモニター用紙に記入していただくことが条件になります。</p>
						...
						<form id="myform" method="post" role="form" action="">
							<table>
								...
								<tr>
									...
									<td>
										...
										1封入物にある全部のQRコード数：<select id="qr_num2" name="qr_num2">
										...
										<div style="font-size:12px;padding:20px;background-color:#dde3de;">
											例）1封入物全部にあるQRコード総個数が1つの場合<br>
											　　⇒「1封入物にある全部のQRコード数」は <strong class="underline-pink">[1] 個</strong><br><br>
											例）1封入物全部にあるQRコード総個数が3つの場合<br>
											　　⇒「1封入物にある全部のQRコード数」は <strong class="underline-pink">[3] 個</strong>
										</div>
									</td>
								</tr>
								<tr>
									...
									<td>
										<div>
											<span>飛び先URL　　</span>
											<input type="text" name="qr1_url" class="middle" placeholder="例　https://test.dm110.jp/qrm" value="<?php echo e($form->get('qr1_url')); ?>" />
								...
								<tr>
									...
									<td>
										<div>
											<span>飛び先URL　　</span>
											<input type="text" name="qr2_url" class="middle" placeholder="例　https://test.dm110.jp/qrm_m_d" value="<?php echo e($form->get('qr2_url')); ?>" />
								...
								<tr>
									...
									<td>
										<div>
											<span>飛び先URL　　</span>
											<input type="text" name="qr3_url" class="middle" placeholder="例　https://test.dm110.jp/qrm_rei" value="<?php echo e($form->get('qr3_url')); ?>" />
								...
								<tr>
									...
									<td>
										<div>
											<span>飛び先URL　　</span>
											<input type="text" name="qr4_url" class="middle" placeholder="例　https://test.dm110.jp/qrm_use" value="<?php echo e($form->get('qr4_url')); ?>" />
								...
								<tr>
									...
									<td>
										<div>
											<span>飛び先URL　　</span>
											<input type="text" name="qr5_url" class="middle" placeholder="例　https://test.dm110.jp/soejyou.html" value="<?php echo e($form->get('qr5_url')); ?>" />
								...
								<tr>
									...
									<td>
										<div>
											<span>飛び先URL　　</span>
											<input type="text" name="qr6_url" class="middle" placeholder="例　https://test.dm110.jp/ichiran.html" value="<?php echo e($form->get('qr6_url')); ?>" />
								...
								<tr>
									...
									<td>
										<div>
											<span>飛び先URL　　</span>
											<input type="text" name="qr7_url" class="middle" placeholder="例　https://test.dm110.jp/kaisyaannai.html" value="<?php echo e($form->get('qr7_url')); ?>" />
								...
								<tr>
									...
									<td>
										<div>
											<span>飛び先URL　　</span>
											<input type="text" name="qr8_url" class="middle" placeholder="例　https://test.dm110.jp/torihiki_jisseki.htm" value="<?php echo e($form->get('qr8_url')); ?>" />
								...
								<tr>
									...
									<td>
										<div>
											<span>飛び先URL　　</span>
											<input type="text" name="qr9_url" class="middle" placeholder="例　https://test.dm110.jp/form/price/" value="<?php echo e($form->get('qr9_url')); ?>" />
								...
								<tr>
									...
									<td>
										<div>
											<span>飛び先URL　　</span>
											<input type="text" name="qr10_url" class="middle" placeholder="例　https://test.dm110.jp/" value="<?php echo e($form->get('qr10_url')); ?>" />
								...
								<tr>
									<td colspan="2">※QRコード１個の場合は初めの１つだけの記入になります。</td>
								</tr>
								<tr>
									<th class="p0-r">
										<em>備考</em>
							...
							<div class="m20-t al-c">
								<p>
									...
									<br /><br />
									下記同意の上、「モニター　QRコード申し込む」ボタンを押してください。
								</p>
							</div>
...
<?php //								<p class="m10-b">3時間以内に返信します <span class="small">（※営業時間内に限ります）</span></p> ?>
								<button type="submit" class="btn btn-form btn-large">モニター　QRコード申し込む（無料）</button>
								<p class="m10-t red">DM発送前と後にモニター用紙に記入していただくことが条件で無料発送になります</p>
							</div>

...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="ja" lang="ja">
	<head>
		...
		<title>小冊子（DMを安く送る方法）　無料プレゼント　フォーム</title>
		<meta name="keywords" content="小冊子 DMを安く送る方法 無料プレゼント" />
		<meta name="description" content="小冊子（DMを安く送る方法）　無料プレゼント" />
		...
		<div id="container">
			...
			<div id="main" class="form_index">
				...
				<div id="main-in">
					...
					<!--メインイメージ-->
					<div id="main-image1">
						<img src="/images/form/ttl_syousassi001.png" alt="無料プレゼント！DMを安く送る方法のすべてが詰まっている小冊子です。午後4時30分までにご注文いただければ当日発送いたします（弊社営業時間）" />
					</div>
					<!--/メインイメージ--> 
					...
					<ul id="breadcrumb" itemscope itemtype="https://schema.org/BreadcrumbList">
						...
						<li itemprop="itemListElement" itemscope itemtype="https://schema.org/ListItem"><span itemprop="name">特別キャンペーン_小冊子プレゼント01</span><meta itemprop="position" content="2" /></li>
					</ul>
					...
					<div id="main-contents3">
						...
						<!--conts-->
						<h2 class="ttl01_wide">小冊子（DMを安く送る方法） 無料プレゼント 入力内容確認</h2>
						<form method="post" role="form" action="#main-contents3">
							<table>
								...
								<tr<?php if ($form->is_error('fax')) : ?> has-error<?php endif; ?>>
									<th>
										<em>FAX番号</em>
								...
								<tr<?php if ($form->is_error('email')) : ?> has-error<?php endif; ?>>
									<th>
										<em>メールアドレス</em>

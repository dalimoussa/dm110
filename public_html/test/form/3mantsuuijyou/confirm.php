						...
						<form method="post" role="form" action="#main-contents3">
							<table>
								...
								<tr>
									...
									<td>
<?php if ($form->get('kinds1')) : ?>
										<?php echo e($form->get('kinds1')); ?>　／　
<?php endif; ?>
<?php if ($form->get('kinds2')) : ?>
										<?php echo e($form->get('kinds2')); ?>　／　
<?php endif; ?>
<?php if ($form->get('kinds3')) : ?>
										<?php echo e($form->get('kinds3')); ?>　／　
<?php endif; ?>
<?php if ($form->get('kinds4')) : ?>
										<?php echo e($form->get('kinds4')); ?>　／　
<?php endif; ?>
									</td>
								</tr>
								<tr>
								...
								<tr>
									...
									<td><?php echo e($form->get('copies')); ?></td>
								</tr>
								<tr>
									<th>
										<em>封筒の種類</em>
									...
									<td><?php echo e($form->get('envelope')); ?></td>
								</tr>

...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="ja" lang="ja">
	...
	<body class="mail_form" id="calorinsatu">
		...
		<div id="container">
			...
			<div id="main" class="form_index">
				...
				<div id="main-in">
					...
					<!--メインイメージ-->
					<div id="main-image1">
						<img src="/images/common/visual_form_calorinsatu.jpg" />
					</div>
					<!--/メインイメージ-->
					...
					<ul id="breadcrumb" itemscope itemtype="https://schema.org/BreadcrumbList">
						...
						<li itemprop="itemListElement" itemscope itemtype="https://schema.org/ListItem"><span itemprop="name">カラー印刷 お見積り</span><meta itemprop="position" content="2" /></li>
					</ul>
					...
					<div id="main-contents3">
						...
						<!--conts-->
						<h2><img src="/images/common/h2_calorinsatu.jpg" /></h2>

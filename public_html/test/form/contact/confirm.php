...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="ja" lang="ja">
	<head>
		...
		<title>お問い合わせ</title>
		<meta name="keywords" content="DM発送代行,お問い合わせ" />
			...
			<div id="main" class="form_index">
				...
				<div id="main-in">
					...
					<div id="main-contents3">
						...
						<!--conts-->
						<h2 class="ttl01_wide">お問い合わせ</h2>
						
						<form method="post" role="form" action="#main-contents3">
							<table>
								<tr<?php if ($form->is_error('category')) : ?> has-error<?php endif; ?>>
									<th><em>お問合せ内容</em></th>
									<td><?php echo e($form->get('category')); ?></td>
								</tr>

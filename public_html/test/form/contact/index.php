...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="ja" lang="ja">
	<head>
		...
		<title>メールお問合せフォーム</title>
		<meta name="keywords" content="DM発送代行,メールお問合せフォーム" />
		<meta name="description" content="DM印刷、封筒印刷、その他作業、お問合せください" />
		...
		<link rel="canonical" href="https://test.dm110.jp/form/contact/">
			...
			<div id="main" class="form_index">
				...
				<div id="main-in">
					...
					<div id="main-contents3">
						...
						<h2 class="ttl01_wide">メールお問合せフォーム</h2>
							...
							<table>
								<tr>
									<th>
										...
										<span class="english">contact category</span>
									</th>
									<td>
										<div>
											<select name="category">
												<option value="" selected="selected">【選択してください】</option>
												<option value="DM発送関連"<?php if ($form->get('category') == 'DM発送関連' ) : ?> selected="selected"<?php endif; ?>>DM発送関連</option>
												<option value="講演・セミナー依頼"<?php if ($form->get('category') == '講演・セミナー依頼' ) : ?> selected="selected"<?php endif; ?>>講演・セミナー依頼</option>
												<option value="JV協業"<?php if ($form->get('category') == 'JV協業' ) : ?> selected="selected"<?php endif; ?>>JV協業</option>
												<option value="その他営業"<?php if ($form->get('category') == 'その他営業' ) : ?> selected="selected"<?php endif; ?>>その他営業</option>
											</select>
											<?php echo $form->error('category', '<span class="error">', '</span>'); ?>
										</div>
								<tr>
									<th>
										<em>御社名</em>
...
*/ ?>
							...
							<div class="m20-t al-c">
								<p>
									...
									その場合は、再度送信いただくか、0561-37-2027　【月～金　9：00～18：00】　加藤までお電話ください。
									<br /><br />

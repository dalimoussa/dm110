...
class Update_deliv_prices
{
	public function up()
	{
		...
		\DB::insert('deliv_prices')->set(array('carrier_id' => 2, 'weight' =>   200, 'quantity' =>    59, 'price' => 138  ))->execute();
		\DB::insert('deliv_prices')->set(array('carrier_id' => 2, 'weight' =>   200, 'quantity' =>    69, 'price' => 138  ))->execute();
		\DB::insert('deliv_prices')->set(array('carrier_id' => 2, 'weight' =>   200, 'quantity' =>    79, 'price' => 138  ))->execute();
		\DB::insert('deliv_prices')->set(array('carrier_id' => 2, 'weight' =>   200, 'quantity' =>    89, 'price' => 138  ))->execute();
		\DB::insert('deliv_prices')->set(array('carrier_id' => 2, 'weight' =>   200, 'quantity' =>    99, 'price' => 138  ))->execute();
		\DB::insert('deliv_prices')->set(array('carrier_id' => 2, 'weight' =>   200, 'quantity' =>   199, 'price' => 113  ))->execute();
		\DB::insert('deliv_prices')->set(array('carrier_id' => 2, 'weight' =>   200, 'quantity' =>   299, 'price' =>  98  ))->execute();
		\DB::insert('deliv_prices')->set(array('carrier_id' => 2, 'weight' =>   200, 'quantity' =>   499, 'price' =>  89  ))->execute();
		\DB::insert('deliv_prices')->set(array('carrier_id' => 2, 'weight' =>   200, 'quantity' =>   999, 'price' =>  83  ))->execute();
		\DB::insert('deliv_prices')->set(array('carrier_id' => 2, 'weight' =>   200, 'quantity' =>  1999, 'price' =>  82  ))->execute();
		\DB::insert('deliv_prices')->set(array('carrier_id' => 2, 'weight' =>   200, 'quantity' =>  2999, 'price' =>  81  ))->execute();
		\DB::insert('deliv_prices')->set(array('carrier_id' => 2, 'weight' =>   200, 'quantity' =>  3999, 'price' =>  76  ))->execute();
		\DB::insert('deliv_prices')->set(array('carrier_id' => 2, 'weight' =>   200, 'quantity' =>  4999, 'price' =>  76  ))->execute();
		\DB::insert('deliv_prices')->set(array('carrier_id' => 2, 'weight' =>   200, 'quantity' =>  9999, 'price' =>  75.5))->execute();
		\DB::insert('deliv_prices')->set(array('carrier_id' => 2, 'weight' =>   200, 'quantity' => 19999, 'price' =>  75  ))->execute();
		\DB::insert('deliv_prices')->set(array('carrier_id' => 2, 'weight' =>   200, 'quantity' => 29999, 'price' =>  74.5))->execute();

...
else if (filemtime($file_path) < filemtime('../../koe-list.xlsx')) include($_SERVER['DOCUMENT_ROOT'].'/enquete/xlsconvert.php');
include($file_path);
...
//	$og_image    = 'cover.jpg';
	$canonical = ($page==1) ? 'https://www.dm110.jp/koe/' : 'https://www.dm110.jp/koe/'.$page.'/';
...
<?php /*
		<div class="link-box-2cu">
			<div class="link-button u-pa10"><a href="https://www.dm110.jp/enquete/" style="display:flex">お客様アンケート原本</a></div>
			<div class="link-button u-pa10"><a href="https://www.dm110.jp/enquete/aggregate/" style="display:flex">お客様アンケート集計結果</a></div>
		</div>
*/ ?>
